...
public final class PointOfInterest {
     ...
     * 
     * @param label
     *            drawn from {@link GazetteerEntryTypes}. May not be <code>null</code> or empty.
     * @param point
     *            geometry representing the point of interest. If drawn from a way or relation, then the centroid. May
     *            not be <code>null</code>.
     * @param houseNumber
     *            optional house number, may not be <code>null</code>.
     * @param street
     *            optional street name, may not be <code>null</code>
     * @param name
     *            optional name, may not be <code>null</code>
     * @throws NullPointerException
     *             if any parameter is <code>null</code>
     * @throws IllegalArgumentException
     *             if label set is empty
     */
    public PointOfInterest(String label, Point point, Optional<String> houseNumber, Optional<String> street,
    ...
    public String toString() {
        return "PointOfInterest [label=" + label + ", point=" + point + ", houseNumber=" + houseNumber + ", street="
                + street + ", name=" + name + "]";
    }
