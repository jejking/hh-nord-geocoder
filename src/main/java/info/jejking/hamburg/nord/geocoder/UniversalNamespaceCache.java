...
/**
 * Copied verbatim (more or less) from http://www.ibm.com/developerworks/library/x-nmspccontext/
 * in order to help formulate xpath queries against the WFS results.
 * 
 * Licensed under the IBM License Agreement, 2009.
 * 
 * @author Holger Kraus, jejking
 *
 */
